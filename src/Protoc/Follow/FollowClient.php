...
class FollowClient extends \Grpc\BaseStub {
    ...
    /**
     * @param \Follow\FollowUnionRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     */
    public function GetFollowUnionByFollowId(\Follow\FollowUnionRequest $argument,
      $metadata = [], $options = []) {
    ...
    /**
     * @param \Follow\UpFollowIdRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     */
    public function UpFollowId(\Follow\UpFollowIdRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/Follow.Follow/UpFollowId',
        $argument,
        ['\Follow\PBEmpty', 'decode'],
        $metadata, $options);
    }
